...
return [
    ...
    "reject" => "Reject",
    "accept" => "Accept",
    "i_accepted" => "Interview accepted",
    "i_rejected" => "Interview rejected",
    "y_w_a" => "You were accepted for this interview",
    "y_w_a_s" => "Interview already accepted",
    "y_w_r" => "You were rejected for this interview",
    "y_w_r_s" => "Interview rejected",
    "filters" => "Filters",
    "day" => "Day",
    "year" => "Year",
